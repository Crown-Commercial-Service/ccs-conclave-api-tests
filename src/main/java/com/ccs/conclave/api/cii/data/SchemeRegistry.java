...
public enum SchemeRegistry {
    ...
    CHARITIES_COMMISSION_WITH_COH_AND_SC("GB-CHC", "Charity Commission for England and Wales", "https://findthatcharity.uk", "Registered Charity Number", "GB"),
    ...
    SCOTLAND_CHARITY_WITH_KNOWN_AND_UNKNOWN_IDENTIFIERS("GB-SC", "Office of The Scottish Charity Regulator (OSCR)", "https://findthatcharity.uk", "Registered Charity Number", "GB"),
