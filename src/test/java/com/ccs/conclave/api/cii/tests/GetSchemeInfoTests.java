...
public class GetSchemeInfoTests extends BaseClass {
    ...
    public void getCompaniesHouseSchemeInfo() {
        ...
        Response response = RestRequests.getSchemeInfo(COMPANIES_HOUSE, expSchemeInfo.getIdentifier().getId());
    ...
    public void getDunsSchemeInfoWithoutAdditionalIdentifier() {
        ...
        Response response = RestRequests.getSchemeInfo(DUN_AND_BRADSTREET, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
    ...
    public void getDunsSchemeInfoWithCOH() {
        ...
        Response response = RestRequests.getSchemeInfo(DUN_AND_BRADSTREET_WITH_COH, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
    ...
    public void getDunsSchemeInfoWithCOHAndCHC() {
        ...
        Response response = RestRequests.getSchemeInfo(DUN_AND_BRADSTREET_WITH_CHC_AND_COH, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
    ...
    public void getGBCharitiesSchemeInfo() {
        ...
        Response response = RestRequests.getSchemeInfo(CHARITIES_COMMISSION, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
...
//        Response response = RestRequests.getSchemeInfo(CHARITIES_COMMISSION_WITH_TWO_COH, expSchemeInfo.getIdentifier().getId());
//        verifyGetSchemeInfoResponse(expSchemeInfo, response);
//    }
    ...
    public void getGBCharitiesSchemeInfoWithCOHAndSC() {
        ...
        Response response = RestRequests.getSchemeInfo(CHARITIES_COMMISSION_WITH_COH_AND_SC, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
    ...
    public void getGBCharitiesSchemeInfoWithKnownAndUnknownIdentifiers() {
        ...
        Response response = RestRequests.getSchemeInfo(CHARITIES_COMMISSION_WITH_KNOWN_AND_UNKNOWN_IDENTIFIERS, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
    ...
    public void getNorthernCharitySchemeInfo() {
        ...
        Response response = RestRequests.getSchemeInfo(NORTHERN_CHARITY, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
    ...
    public void getNorthernCharitySchemeInfoWithCOH() {
        ...
        Response response = RestRequests.getSchemeInfo(NORTHERN_CHARITY_WITH_COH, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
    ...
    public void getScottishCharitySchemeInfo() {
        ...
        Response response = RestRequests.getSchemeInfo(SCOTLAND_CHARITY, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
    ...
    public void getScottishCharitySchemeInfoWithCOHAndCHC() {
        ...
        Response response = RestRequests.getSchemeInfo(SCOTLAND_CHARITY_WITH_CHC_COH, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
    ...
    public void getDuplicateWithAdditionalIdentifier() {
        ...
        Response response = RestRequests.getSchemeInfo(COMPANIES_HOUSE, expSchemeInfo.getAdditionalIdentifiers().get(0).getId());
        RestRequests.postSchemeInfo(response.asString());

        response = RestRequests.getSchemeInfo(DUN_AND_BRADSTREET_WITH_COH, expSchemeInfo.getIdentifier().getId());
    ...
    public void getSchemeInfoWithAlreadyRegIDAndInvalidScheme() {
        ...
        response = RestRequests.getSchemeInfo(NORTHERN_CHARITY, expSchemeInfo.getIdentifier().getId());
        verifyInvalidIdResponse(response);
    }
    ...
    public void getActiveSCCharitiesWithInactiveAndActiveAdditionalIDInfo() {
        ...
        Response response = RestRequests.getSchemeInfo(SCOTLAND_CHARITY_WITH_KNOWN_AND_UNKNOWN_IDENTIFIERS, expSchemeInfo.getIdentifier().getId());
        verifyGetSchemeInfoResponse(expSchemeInfo, response);
    }
